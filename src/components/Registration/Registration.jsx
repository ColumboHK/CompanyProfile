...
const Registration = () => {
    ...
    return (
        <div className="pt-24 bg-[#E7EFF8]">
        {/* // <section className="bg-cyan-50"> */}
            <h1 className="px-12 text-[2.5rem] font-semibold leading-normal capitalize sm:pr-8 xl:pr-10 pt-24">
                Registration
            </h1>
                ...
                <div className="px-12">
                    ...
                    <div className="pb-2 flex" style={{ justifyContent: 'center', alignItems: 'center'}}>
                        ...
                        <input className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 
                                          focus:border-blue-500 block w-25 p-2.5 dark:bg-slate-300 dark:border-gray-600 
                                          dark:placeholder-gray-500 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                               type="text" value={confirmPassword} onChange = {(e) => handleInputChange(e)} id="confirmPassword" placeholder="Group"/>
                    </div>
                    <div className="pb-2 flex" style={{ justifyContent: 'center', alignItems: 'center'}}>
                        <label className="font-semibold pr-28">
                            Hobby
                        ...
                        <input className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 
                                          focus:border-blue-500 block w-25 p-2.5 dark:bg-slate-300 dark:border-gray-600 
                                          dark:placeholder-gray-500 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                               type="text" value={confirmPassword} onChange = {(e) => handleInputChange(e)} id="confirmPassword" placeholder="Hobby"/>
                    </div>
